...
type SubscriptionInitParameters struct {
	...
	DataTypeRef *v1.NamespacedReference `json:"dataTypeRef,omitempty" tf:"-"`

	// Selector for a DataType in mdm to populate dataType.
	// +kubebuilder:validation:Optional
	DataTypeSelector *v1.NamespacedSelector `json:"dataTypeSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SubscriberRef *v1.NamespacedReference `json:"subscriberRef,omitempty" tf:"-"`

	// Selector for a SqsSubscriber to populate subscriberId.
	// +kubebuilder:validation:Optional
	SubscriberSelector *v1.NamespacedSelector `json:"subscriberSelector,omitempty" tf:"-"`
}
