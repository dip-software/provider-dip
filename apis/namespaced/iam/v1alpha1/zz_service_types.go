...
type ServiceInitParameters struct {
	...
	SelfManagedCertificateSecretRef *v1.LocalSecretKeySelector `json:"selfManagedCertificateSecretRef,omitempty" tf:"-"`
	...
	// Mutually exclusive with `self_managed_certificate`
	SelfManagedPrivateKeySecretRef *v1.LocalSecretKeySelector `json:"selfManagedPrivateKeySecretRef,omitempty" tf:"-"`
