...
type ApplicationInitParameters struct {
	...
	PropositionIDSelector *v1.NamespacedSelector `json:"propositionIdSelector,omitempty" tf:"-"`

	// Reference to a Proposition in iam to populate propositionId.
	// +kubebuilder:validation:Optional
	PropositionRef *v1.NamespacedReference `json:"propositionRef,omitempty" tf:"-"`
